...
input_file_names = ["dsrA_antisense_match_location_result.txt"]
output_promoter = True
if __name__ == '__main__':
    ...
    for file_name in input_file_names:
        ...
        format_data_to_tsv(file_path, file_path.replace('.txt', '_format.tsv'), ecocyc_data_loader, output_promoter)
